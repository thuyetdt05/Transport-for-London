...
def create_main_report():
    ...
    add_paragraph(doc, "                                                        Nhóm 14 — Lớp DHKTDL17A",
    ...
    cluster_results = [
        ("Siêu trung tâm", "8", "37,315,886", "−73.70%", "+12.5%", "King's Cross, Waterloo, Victoria, London Bridge, Paddington, Liverpool Street, Euston, Canary Wharf"),
        ("Ga lớn", "42", "11,268,126", "−63.47%", "+18.2%", "Oxford Circus, Bank, Stratford, Brixton, Hammersmith, ..."),
        ("Ga trung bình", "78", "3,136,520", "−54.91%", "+15.8%", "Angel, Aldgate, Bethnal Green, Canning Town, ..."),
        ("Ga nhỏ", "80", "2,833,787", "−57.42%", "+14.2%", "Các ga ngoại ô trung tâm"),
        ("Ga ít khách", "37", "2,215,412", "−49.69%", "+11.6%", "Các ga vùng ven nội thành"),
        ("Ga rất ít khách", "53", "1,630,990", "−41.42%", "+9.8%", "Các ga ngoại ô xa trung tâm"),
    ]
    ...
    top10_stations = [
        ("1", "King's Cross St. Pancras", "Siêu trung tâm", "62,388,000", "−75.2%", "Ga liên thông 6 tuyến metro + đường sắt quốc gia"),
        ("2", "Waterloo", "Siêu trung tâm", "58,912,000", "−74.8%", "Ga đường sắt lớn nhất nước Anh"),
        ("3", "Victoria", "Siêu trung tâm", "54,276,000", "−72.1%", "Cửa ngõ sân bay Gatwick"),
        ("4", "London Bridge", "Siêu trung tâm", "51,843,000", "−71.9%", "Hub quan trọng khu tài chính City"),
        ("5", "Paddington", "Siêu trung tâm", "48,920,000", "−73.5%", "Kết nối Elizabeth Line mới"),
        ("6", "Liverpool Street", "Siêu trung tâm", "46,157,000", "−72.6%", "Ga phục vụ khu East London"),
        ("7", "Euston", "Siêu trung tâm", "43,218,000", "−74.1%", "Cửa ngõ Bắc Anh và Scotland"),
        ("8", "Canary Wharf", "Siêu trung tâm", "35,476,000", "−69.8%", "Trung tâm tài chính thứ 2 London"),
        ("9", "Stratford", "Ga lớn", "28,934,000", "−61.2%", "Hub Olympic legacy"),
        ("10", "Brixton", "Ga lớn", "22,187,000", "−58.9%", "Trung tâm Nam London"),
    ]
    ...
    add_heading_1(doc, "6.2", "Hạn chế và khó khăn gặp phải")
    ...
    add_heading_1(doc, "6.3", "Giải pháp khắc phục")
...
├── generate_pdf_report.py    # Sinh báo cáo PDF
├── create_presentation.py    # Tạo file trình bày
...
├── Bao_Cao_TfL.pdf           # Báo cáo PDF (copy từ outputs)
└── outputs/
    ...
    ├── TfL_Project_Report.pdf        # Báo cáo PDF tóm tắt
    ├── analysis_summary.txt          # Báo cáo text
